class V94LLI extends KFWeapon;

#exec OBJ LOAD FILE="V94LLI_A.ukx"
		...
		Instigator.IsHumanControlled() )
	{
		if( KFScopeDetail == KF_ModelScope )
		{
			...
			if( ScriptedScopeCombiner == none )
			{
				...
				ScriptedScopeCombiner.Material1 = Texture'V94LLI_A.V94LLI_T.V94LLI_scope';
			...
			if( ScriptedScopeStatic == none )
			{
	            ...
	            ScriptedScopeStatic.Material1 = Texture'V94LLI_A.V94LLI_T.V94LLI_scope_dot';
...
defaultproperties
{
	...
	ZoomMat=FinalBlend'V94LLI_A.V94LLI_T.V94LLI_scope_FB'
	lenseMaterialID=2
	scopePortalFOVHigh=9.000000
	scopePortalFOV=9.000000
	ScriptedTextureFallback=Texture'V94LLI_A.V94LLI_T.AlphaLens'
	bHasScope=True
	...
	HudImage=Texture'V94LLI_A.V94LLI_T.V94LLI_Unselected'
	SelectedHudImage=Texture'V94LLI_A.V94LLI_T.V94LLI_selected'
	Weight=14.000000
	bHasAimingMode=True
	IdleAimAnim="Idle_Iron"
	StandardDisplayFOV=65.000000
	bModeZeroCanDryFire=True
	TraderInfoTexture=Texture'V94LLI_A.V94LLI_T.V94LLI_Trader'
	PlayerIronSightFOV=17.000000
	ZoomedDisplayFOV=27.000000
	FireModeClass(0)=Class'V94LLImut.V94LLIFire'
	FireModeClass(1)=Class'KFMod.NoFire'
	PutDownAnim="PutDown"
	SelectSound=Sound'V94LLI_A.V94LLI_Snd.V94LLI_select'
	...
	InventoryGroup=4
	GroupOffset=3
	PickupClass=Class'V94LLImut.V94LLIPickup'
	PlayerViewOffset=(X=4.000000,Y=30.000000,Z=-14.000000)
	BobDamping=6.000000
	AttachmentClass=Class'V94LLImut.V94LLIAttachment'
	IconCoords=(X1=253,Y1=146,X2=333,Y2=181)
	ItemName="V-94 Volga"
	Mesh=SkeletalMesh'V94LLI_A.V94LLIDT_mesh'
	Skins(0)=Shader'V94LLI_A.V94LLI_T.V94LLI_tex_1_shdr'
	Skins(1)=Combiner'KF_Weapons5_Trip_T.Weapons.M99_cmb'
	Skins(2)=Texture'V94LLI_A.V94LLI_T.AlphaLens'
