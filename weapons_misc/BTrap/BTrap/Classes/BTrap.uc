class BTrap extends KFWeapon;

#exec OBJ LOAD FILE=BTrap_A.ukx package="BTrap"
...
{
     MagCapacity=1
     HudImage=Texture'BTrap.BTrap_Trader'
     SelectedHudImage=Texture'BTrap.BTrap_Trader'
     Weight=1.000000
     StandardDisplayFOV=65.000000
     bModeZeroCanDryFire=True
     SleeveNum=0
     TraderInfoTexture=Texture'BTrap.BTrap_Trader'
     bIsTier2Weapon=True
     FireModeClass(0)=Class'BTrap.BTrapFire'
     FireModeClass(1)=Class'KFMod.NoFire'
     PutDownAnim="PutDown"
     SelectSound=Sound'BTrap.BTrap_Take'
     SelectForce="SwitchToAssaultRifle"
     AIRating=0.550000
     CurrentRating=0.550000
     bShowChargingBar=True
     bCanThrow=False
     Description="A Bear Trap that can temporarely stop big zeds."
     EffectOffset=(X=100.000000,Y=25.000000,Z=-10.000000)
     DisplayFOV=65.000000
     Priority=1
     InventoryGroup=5
     GroupOffset=11
     PickupClass=Class'BTrap.BTrapPickup'
     BobDamping=6.000000
     AttachmentClass=Class'BTrap.BTrapAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="Bear Trap"
     Mesh=SkeletalMesh'BTrap.BTMesh'
     Skins(1)=Texture'BTrap.BTrapSkin'
