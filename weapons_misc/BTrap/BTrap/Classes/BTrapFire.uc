class BTrapFire extends KFShotgunFire;
...
defaultproperties
{
     ProjectileSpawnDelay=0.900000
     ProjPerFire=1
     ProjSpawnOffset=(X=10.000000,Y=0.000000,Z=-30.000000)
     ...
     NoAmmoSound=None
     FireRate=1.750000
     AmmoClass=Class'BTrap.BTrapAmmo'
     ProjectileClass=Class'BTrap.BTrapProjectile'
