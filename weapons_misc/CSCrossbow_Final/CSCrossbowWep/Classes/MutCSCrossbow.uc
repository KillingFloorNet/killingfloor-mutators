class MutCSCrossbow extends Mutator;

// 
// A template by BadKarMa.
// 
// Use this template to add a trader-mutator to your self created custom weapons.
// 
// Feel free to copy, use and change this template!
// 
// 
// WHAT IT DOES:
// 	- Add an item to the trader shop.  
// 	- Autoloads this item for the correct perk. 
// 	- Adds this item to the serverpackages.
// 	- Does NOT overwrite an existing itemslot.
// 	- Works together with other mutators based on this.
// 	- You can also add multiple weapons with one mutator. 
// 
// 
// REQUIREMENTS:
// 	Your weapon requires a WeaponPickup class. 
//	That class needs to meet all requirements for the trader.
//
// HOW TO USE THIS TEMPLATE:
// 	1.) create a file "AddWeaponMutator.uc" in your weapons source package folder 
// 		(or any other source folder you want to compile)
// 	2.) copy & paste this sourcecode to the file
// 	3.) change the marked settings in the default properties at the bottom of this text
// 
// OTHER NOTES:
...
defaultproperties
{
	...
	newweapons[0] = "CSCrossbowWep.CSCrossbowPickup"			
