class CSCrossbowArrow extends Projectile;
...
Ignores HitWall;
	...
	function ProcessTouch (Actor Other, vector HitLocation)
	{
		...
		if( Pawn(Other)!=None && Pawn(Other).Inventory!=None )
		{
			...
			{
				if( CSCrossbow(Inv)!=None && Weapon(inv).AmmoAmount(0)<Weapon(inv).MaxAmmo(0) )
				{
...
defaultproperties
{
     ...
     MyDamageType=Class'CSCrossbowWep.DamTypeCSCrossbow'
