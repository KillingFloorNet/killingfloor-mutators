class FlaregunProj extends Nade;

#exec OBJ LOAD FILE=kf_generic_sm.usx

var FlaregunFlareSmokeEmitter FlareSmoke;

simulated function PostBeginPlay()
{
	Super.PostBeginPlay();
	
	FlareSmoke = Spawn(class'FlaregunFlareSmokeEmitter',self);
...
defaultproperties
{
     ...
     bDynamicLight=True
     AmbientSound=Sound'BOGPDTv2_A.flarehiss'
     LifeSpan=151.000000
     DrawScale=3.000000
     bUnlit=True
     bFullVolume=True
