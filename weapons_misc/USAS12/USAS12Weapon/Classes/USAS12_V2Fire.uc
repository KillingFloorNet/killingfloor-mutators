...
// Shotgun Fire
//=============================================================================
class USAS12_V2Fire extends KFShotgunFire;
...
defaultproperties
{
    ...
    KickMomentum=(X=-20.000000,Z=5.000000)
    maxVerticalRecoilAngle=1200
    maxHorizontalRecoilAngle=600
    FireAimedAnim="Fire_Iron"
    StereoFireSound=Sound'USAS12_V2_A.USAS12_V2_SND.usas_shoot_stereo'
    ...
    FireSound=Sound'USAS12_V2_A.USAS12_V2_SND.usas_shoot_mono'
    FireRate=0.200000
    AmmoClass=Class'USAS12_V2Ammo'
    ...
    ProjectileClass=Class'USAS12_V2Bullet'
