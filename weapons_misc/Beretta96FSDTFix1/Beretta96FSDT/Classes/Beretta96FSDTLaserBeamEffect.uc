...
//=============================================================================
class Beretta96FSDTLaserBeamEffect extends xEmitter;
...
simulated function Tick(float dt)
{
	...
	local Beretta96FSDTAttachment Attachment;
	...
	else
	{
		...
		else
		{
			...
			Attachment = Beretta96FSDTAttachment(xPawn(Instigator).WeaponAttachment);
