class FlareTrail extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=32))
         Opacity=0.500000
         FadeOutStartTime=10.000000
         CoordinateSystem=PTCS_Relative
         MaxParticles=1
         StartLocationOffset=(Y=15.000000)
     ...
     End Object
     Emitters(0)=SpriteEmitter'Flares.FlareTrail.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         StartSizeRange=(X=(Min=1.000000,Max=2.000000),Y=(Min=0.000000,Max=0.000000),Z=(Min=0.000000,Max=0.000000))
     ...
     End Object
     Emitters(1)=SpriteEmitter'Flares.FlareTrail.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         MaxParticles=100
         DetailMode=DM_High
         StartLocationOffset=(Y=15.000000,Z=1.000000)
     ...
     End Object
     Emitters(2)=SpriteEmitter'Flares.FlareTrail.SpriteEmitter2'

     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         UniformSize=True
         ColorScale(0)=(RelativeTime=0.100000,Color=(G=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=255,A=32))
         ...
         RelativeWarmupTime=30.000000
     End Object
     Emitters(3)=SpriteEmitter'Flares.FlareTrail.SpriteEmitter3'

     LightType=LT_Steady
     LightHue=125
     LightSaturation=64
     LightBrightness=185.000000
