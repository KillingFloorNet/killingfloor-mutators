class MutAdd_AA12DW extends Mutator;
...
function ModifyPlayer(Pawn Player)
{
	 ...
	 // CHANGE THIS LINE BEFORE ANYTHING ELSE!
     Player.GiveWeapon("AA12DW.AA12DWAutoShotgun");
}

// The rest of this mutator is based on a template by BadKarMa
...
defaultproperties
{
	...
	FriendlyName="AA12 Dual Wielding"
	Description="This mutator adds dual AA12s to your starting inventory and to the trader menu "
	GroupName="KF-AA12DW"						
	thisPackageName="???"
	newweapons[0] = "AA12DW.AA12DWPickup"					
}
