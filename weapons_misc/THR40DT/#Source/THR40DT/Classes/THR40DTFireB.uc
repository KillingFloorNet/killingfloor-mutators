class THR40DTFireB extends KFMeleeFire;
...
/* 			if ( (HitActor.IsA('KFMonster') || HitActor.IsA('KFHumanPawn')) && KFWeapon(Weapon).BloodyMaterial!=none )
			...
			Spawn(class'THR40DTPush',,, HitLocation, PointRot);//Flame
		}
...
defaultproperties
{
	...
	DamagedelayMin=0.430000
	DamagedelayMax=0.430000
	hitDamageClass=Class'DamTypeTHR40DTm'
	MeleeHitSounds(0)=Sound'KF_AxeSnd.AxeImpactBase.Axe_HitFlesh4'
	HitEffectClass=Class'THR40DTHitEffect'
