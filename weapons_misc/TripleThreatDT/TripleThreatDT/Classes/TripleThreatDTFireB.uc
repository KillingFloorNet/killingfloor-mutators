class TripleThreatDTFireB extends KFMeleeFire;
...
/* 			if ( (HitActor.IsA('KFMonster') || HitActor.IsA('KFHumanPawn')) && KFWeapon(Weapon).BloodyMaterial!=none )
			...
			Spawn(class'TripleThreatDTPush',,, HitLocation, PointRot);//Flame
		}
...
defaultproperties
{
	...
	DamagedelayMin=0.530000
	DamagedelayMax=0.530000
	hitDamageClass=Class'TripleThreatDTDamTypeM'
	MeleeHitSounds(0)=Sound'KF_AxeSnd.AxeImpactBase.Axe_HitFlesh4'
	HitEffectClass=Class'TripleThreatDTHitEffect'
