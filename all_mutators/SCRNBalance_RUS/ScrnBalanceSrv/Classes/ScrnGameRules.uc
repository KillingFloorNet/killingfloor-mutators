...
defaultproperties
{
     ...
     HLMult_Normal=0.500000
     HL_Hard=2.000000
     HLMult_Hard=0.750000
     HL_Suicidal=5.000000
     HLMult_Suicidal=1.000000
     HL_HoE=7.000000
     HLMult_HoE=1.000000
     HL_Hardcore=2.000000
     HL_Story=3.000000
     HL_TSC=6.000000
     HardcoreZeds(0)=(MonsterClass="ZombieGhost",HL=0.500000)
     HardcoreZeds(1)=(MonsterClass="ZombieShiver",HL=1.000000)
     HardcoreZeds(2)=(MonsterClass="ZombieJason",HL=1.500000)
     HardcoreZeds(3)=(MonsterClass="TeslaHusk",HL=1.500000)
     HardcoreZeds(4)=(MonsterClass="ZombieJason",HL=1.500000)
     HardcoreZeds(5)=(MonsterClass="ZombieBrute",HL=2.000000)
     HardcoreZeds(6)=(MonsterClass="FemaleFP",HL=2.500000)
     HardcoreZeds(7)=(MonsterClass="FemaleFP_MKII",HL=2.500000)
     HardcoreZeds(8)=(MonsterClass="ZombieSuperStalker",HL=0.300000)
     HardcoreZeds(9)=(MonsterClass="ZombieSuperGorefast",HL=0.300000)
     HardcoreZeds(10)=(MonsterClass="ZombieSuperCrawler",HL=0.300000)
     HardcoreZeds(11)=(MonsterClass="ZombieSuperBloat",HL=0.300000)
     HardcoreZeds(12)=(MonsterClass="ZombieSuperSiren",HL=1.000000)
     HardcoreZeds(13)=(MonsterClass="ZombieSuperFP",HL=1.000000)
     HardcoreZeds(14)=(MonsterClass="ZombieSuperHusk",HL=1.400000)
     HardcoreZeds(15)=(MonsterClass="ZombieSuperScrake",HL=1.400000)
     HardcoreZeds(16)=(MonsterClass="Imp",HL=1.000000)
     HardcoreZeds(17)=(MonsterClass="Pinky",HL=1.000000)
     HardcoreZeds(18)=(MonsterClass="Archvile",HL=1.000000)
     HardcoreZeds(19)=(MonsterClass="HellKnight",HL=1.000000)
     HardcoreZeds(20)=(MonsterClass="Sabaoth",HL=1.000000)
     HardcoreZeds(21)=(MonsterClass="Vagary",HL=1.000000)
     HardcoreZeds(22)=(MonsterClass="Maledict",HL=1.000000)
     HardcoreZeds(23)=(MonsterClass="HunterInvul",HL=1.000000)
     HardcoreZeds(24)=(MonsterClass="HunterBerserk",HL=1.000000)
     HardcoreZeds(25)=(MonsterClass="HunterHellTime",HL=1.000000)
     HardcoreZeds(26)=(MonsterClass="Guardian",HL=1.000000)
     HardcoreZeds(27)=(MonsterClass="Cyberdemon",HL=1.000000)
     HardcoreBosses(0)=(MonsterClass="HardPat",HL=2.000000)
     HardcoreBosses(1)=(MonsterClass="ZombieSuperBoss",HL=2.000000)
     HardcoreBosses(2)=(MonsterClass="Sabaoth",HL=2.000000)
     HardcoreBosses(3)=(MonsterClass="Vagary",HL=1.000000)
     HardcoreBosses(4)=(MonsterClass="Maledict",HL=2.000000)
     HardcoreBosses(5)=(MonsterClass="HunterInvul",HL=2.000000)
     HardcoreBosses(6)=(MonsterClass="HunterBerserk",HL=2.000000)
     HardcoreBosses(7)=(MonsterClass="HunterHellTime",HL=2.000000)
     HardcoreBosses(8)=(MonsterClass="Guardian",HL=2.000000)
     HardcoreBosses(9)=(MonsterClass="Cyberdemon",HL=2.000000)
}
