...
defaultproperties
{
     ...
     AchDefs(60)=(id="Ash",DisplayName="Tribute to Ash Williams",Description="Kill 50 zeds in a wave with Boomstick and Chainsaw. Do not use any other weapons!",Icon=Texture'ScrnAch_T.Achievements.Ash',MaxProgress=1,bForceShow=True,DataSize=1)
     ...
     AchDefs(95)=(id="PerfectWave",DisplayName="Perfect Wave",Description="Survive %c waves in 5+ player game without anybody taking a damage. Wave 1 excluding.",Icon=Texture'ScrnAch_T.Teamwork.PerfectWave',MaxProgress=15,DataSize=4,Group="TW")
     ...
     AchDefs(106)=(id="Friday13",DisplayName="Friday the 13th",Description="Survive the wave after 5 of your teammates got killed by Jason Voorhees.",Icon=Texture'ScrnAch_T.Achievements.Friday13',MaxProgress=1,FilterMaskAll=32,DataSize=1)
     ...
     AchDefs(143)=(id="MacheteWalker",DisplayName="Machete Marathon",Description="Perform 'Machete-sprint': drop/pickup Machete 422 times while running in a single game",Icon=Texture'ScrnAch_T.Achievements.MacheteWalker',MaxProgress=1,bForceShow=True,DataSize=1)
