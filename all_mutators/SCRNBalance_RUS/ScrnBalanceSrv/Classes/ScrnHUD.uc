...
var globalconfig bool bCoolHud;
var globalconfig float CoolHudScale;
var globalconfig bool bCoolHudLeftAlign;
var globalconfig float CoolHudAmmoOffsetX, CoolHudAmmoOffsetY, CoolHudAmmoScale;
var bool bCoolHudTeamColor;
var color CoolHudColor, CoolHudAmmoColor;
var globalconfig byte PlayerInfoVersionNumber;
var globalconfig float PlayerInfoScale;
...
var globalconfig float CoolHealthFadeOutTime;
...
var transient protected float TestC; // for debug purposes
...
simulated function DrawOldHudItems(Canvas C)
{
    ...
    TempY = C.ClipY * 0.93 - TempSize;
    // bonus level
    if ( ScrnPerk.static.GetClientVeteranSkillLevel(KFPRI) != KFPRI.ClientVeteranSkillLevel ) {
    ...
    float BaseX, float BaseY, float BaseSize)
{
    ...
    if ( EnemyPerk!=none && EnemyPerk.default.OnHUDIcon!=none )
    {
        ...
        PerkLevel = EnemyPerk.static.GetClientVeteranSkillLevel(KFPRI);
...
defaultproperties
{
     ...
     CowboyTileY=0.020000
     BlamedIcon=(WidgetTexture=Texture'ScrnTex.HUD.Crap64',RenderStyle=STY_Alpha,TextureCoords=(X2=64,Y2=64),TextureScale=0.500000,PosX=0.950000,PosY=0.500000,ScaleMode=SM_Right,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=255),Tints[1]=(B=255,G=255,R=255,A=255))
     BlamedIconSize=32.000000
     ...
     TraderGroupColor=(B=128,G=128,R=128,A=255)
     TraderActiveGroupColor=(B=255,G=192,R=192,A=255)
     TraderSelectedGroupColor=(B=255,G=192,R=192,A=255)
     TraderPriceButtonColor=(B=160,G=160,R=160,A=255)
     TraderPriceButtonDisabledColor=(B=255,G=255,R=255,A=255)
     TraderPriceButtonSelectedColor=(B=160,G=128,R=255,A=255)
     strFollowing="FOLLOWING:"
     bCoolHud=True
     CoolHudScale=2.000000
     CoolHudAmmoOffsetX=0.995000
     CoolHudAmmoOffsetY=0.950000
     CoolHudAmmoScale=0.750000
     CoolHudColor=(B=255,G=255,R=255,A=255)
     CoolHudAmmoColor=(B=160,G=160,R=160,A=200)
     PlayerInfoVersionNumber=90
     PlayerInfoScale=1.000000
     CoolBarBase=Texture'ScrnTex.HUD.BarBase'
     CoolBarOverlay=Texture'ScrnTex.HUD.BarOverlay'
     CoolBarSize=512
     CoolHealthBarTop=30
     CoolHealthBarHeight=350
     HealthBarColor=(R=192,A=200)
     HealingBarColor=(B=128,G=128,R=255,A=200)
     FullHealthColor=(G=192,A=200)
     OverchargeHealthColor=(B=255,G=255,A=200)
     LowHealthColor=(G=50,R=210,A=200)
     ArmorBarColor=(B=200,A=200)
     BigArmorColor=(B=255,G=255,A=200)
     CoolPerkToBarSize=0.750000
     CoolStarToBarSize=0.125000
     CoolStarAngleRad=0.261799
     CoolPerkLevelOffsetY=0.870000
     CoolIconToBarSize=0.750000
     CoolHealthFadeOutTime=10.000000
     strBonusLevel="^Bonus Level^"
     CoolPerkLevelDigits=(RenderStyle=STY_Alpha,DrawPivot=DP_MiddleMiddle,OffsetX=5,OffsetY=-2)
     CoolCashIcon=(WidgetTexture=Texture'ScrnTex.HUD.Hud_Pound_Symbol_BW',RenderStyle=STY_Alpha,TextureCoords=(X2=64,Y2=64),TextureScale=0.250000,PosY=0.004000,Scale=1.000000,Tints[0]=(B=255,G=255,R=255,A=200),Tints[1]=(B=255,G=255,R=255,A=200))
     CoolCashDigits=(RenderStyle=STY_Alpha,TextureScale=0.500000,PosX=0.030000,PosY=0.005000,Tints[0]=(B=160,G=160,R=160,A=200),Tints[1]=(B=160,G=160,R=160,A=200))
     PulseRate=450.000000
     XPLevelShowTime=30.000000
     BonusLevelShowTime=2.000000
     XPBonusFadeRate=500.000000
     bShowDamages=True
     DamagePopupFont=4
     DamagePopupFadeOutTime=3.000000
     bShowSpeed=True
     SpeedometerX=0.850000
     SpeedometerFont=5
     BlameCountdown=120.000000
     BlameDrawDistance=800.000000
     bDrawSpecDeaths=True
     WhiteAlphaColor=(B=255,G=255,R=255,A=255)
     PerkColors(0)=(R=255,A=255)
     PerkColors(1)=(B=127,G=255,R=255,A=255)
     PerkColors(2)=(G=225,A=255)
     PerkColors(3)=(B=255,G=125,A=255)
     PerkColors(4)=(B=255,R=178,A=255)
     PerkColors(5)=(G=128,R=255,A=255)
     PerkColors(6)=(R=160,A=255)
     TeamColors(0)=(B=64,G=64,R=255,A=255)
     TeamColors(1)=(B=198,G=153,R=90,A=255)
     TextColors(0)=(B=50,G=50,R=255,A=255)
     TextColors(1)=(B=198,G=139,R=75,A=255)
     strPendingItems="Waiting for shop items from server: "
     ChatIcon=Texture'ScrnTex.HUD.ChatIcon'
     ScrnDrawPlayerInfoBase=ScrnHUD.ScrnDrawPlayerInfoNew
     WeightDigits=(PosY=0.942000)
     HealthBarFullVisDist=350.000000
     HealthBarCutoffDist=1000.000000
     DigitsSmall=(TextureCoords[0]=(X2=32))
}
