...
function float GetHeadScaleFor(Pawn P)
{
	...
	if ( abs(P.PlayerReplicationInfo.Deaths) < 1 )
		...
		NewScale = (P.PlayerReplicationInfo.Score+1)/(P.PlayerReplicationInfo.Deaths+1)/1000;
...
defaultproperties
{
     GroupName="KF-BigHead"
     FriendlyName="BigHead"
     Description="Head size depends on how much money you have."
}
