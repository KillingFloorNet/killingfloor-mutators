...
//-----------------------------------------------------------
class RTDSpawnMiniBosses extends RTDFaceBase;
...
static simulated function ModifyPawn(Pawn Other)
{
    ...
    AmountToSpawn = 1; // One is enough :P
    ...
    {
        SpawnZombie(Other.Controller, None, class'KFModsRTD.RTDMiniBossChar', Other.Location, Other.Rotation);
    }
...
defaultproperties
{
     AlmostAttrackedMsg="almost lured in a mini boss. Good lord, that was close!"
     PersonalAlmostAttrackedMsg="You almost lured in a mini boss. Be more careful next time!"
     Message="has lured in a mini boss! Watch it!"
     PersonalMessage="You lured a mini boss! Kill it!"
     FaceType=6
}
