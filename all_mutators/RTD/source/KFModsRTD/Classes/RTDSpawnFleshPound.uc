...
//-----------------------------------------------------------
class RTDSpawnFleshPound extends RTDFaceBase;
...
static simulated function ModifyPawn(Pawn Other)
{
    ...
    AmountToSpawn = 1; // Just one

    // Find a ZombieVolume
    ZV = FindSpawningVolume(Other.Controller, false);
...
defaultproperties
{
     AlmostAttrackedMsg="almost lured in a Flesh Pound! Good lord, that was close!"
     PersonalAlmostAttrackedMsg="You almost lured in a Flesh Pound! Watch it next time!"
     Message="has lured in a Flesh Pound! Watch it!"
     PersonalMessage="You lured in a Flesh Pound! Kill it! Kill it now!"
     FaceType=2
}
