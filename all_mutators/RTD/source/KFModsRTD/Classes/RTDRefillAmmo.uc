...
//-----------------------------------------------------------
class RTDRefillAmmo extends RTDFaceBase;
...
defaultproperties
{
     Message="found a dumpster full of ammo!"
     PersonalMessage="You have found a dumpster full of ammo!"
     FaceType=0
}
