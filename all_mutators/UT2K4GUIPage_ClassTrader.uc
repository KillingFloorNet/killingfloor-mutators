// ClassTrader is the GUI page that allows the player to select a player class. 
// It gets the list of available player classes from the RegularPRI 
// and asks the RegularPlayer to swap teams, if needed, or to assign the player class and restart the pawn.
