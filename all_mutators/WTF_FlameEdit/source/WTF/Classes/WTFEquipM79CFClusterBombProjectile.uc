class WTFEquipM79CFClusterBombProjectile extends M79GrenadeProjectile;
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
		Spawn(Class'WTFEquipM79CFExplosionEmitter',self,,HitLocation + HitNormal*20,rotator(HitNormal));
	}
	BlowUp(HitLocation);
	...
	{   
		...
		{
			rot = Rotation;
			rot.yaw += FRand()*32000-8000;
			rot.pitch += FRand()*32000-8000;
			rot.roll += FRand()*32000-8000;
...
defaultproperties
{
	ProjectileClass=Class'WTFEquipM79CFClusterBomblet'
	NumProjectiles=4
	Speed=1250.000000
