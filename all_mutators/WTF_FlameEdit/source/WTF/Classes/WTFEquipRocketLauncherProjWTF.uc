class WTFEquipRocketLauncherProjWTF extends LAWProj;
...
simulated function Timer()
{
	...
	if (WaitCounter == 20)
	{
		...
		PlaySound(Sound'WTF_A.WTFBOOM', , 10.0, , 5000.0);
	}
	else if (WaitCounter == 28)
	{
		...
		Spawn(Class'WTFEquipRocketLauncherProjWTFExplosion',self,,Self.Location,rotator(Self.Location));
