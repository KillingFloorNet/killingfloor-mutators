...
defaultproperties
{
	BloodyMaterial=Texture'WTF_A.Chainsaw.Chainsaw_bloody'
	BloodyMaterialRef="WTF_A.Chainsaw.Chainsaw_bloody"
	FireModeClass(0)=Class'WTFEquipChainsawFire'
	FireModeClass(1)=Class'WTFEquipChainsawAltFire'
	Description="A deadly weapon"
	PickupClass=Class'WTFEquipChainsawPickup'
	AttachmentClass=Class'WTFEquipChainsawAttachment'
	Skins(0)=Texture'WTF_A.Chainsaw.Chainsaw'
	Skins(1)=TexPanner'KF_Specimens_Trip_T.scrake_saw_panner'
	SkinRefs(0)="WTF_A.Chainsaw.Chainsaw"
