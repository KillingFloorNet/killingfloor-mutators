...
defaultproperties
{
	BloodyMaterial=Texture'WTF_A.Fireaxe.Fireaxe_bloody'
	BloodyMaterialRef="WTF_A.Fireaxe.Fireaxe_bloody"
	FireModeClass(0)=Class'WTFEquipFireAxeFire'
	FireModeClass(1)=Class'WTFEquipFireAxeFireB'
	Description="A deadly weapon"
	PickupClass=Class'WTFEquipFireAxePickup'
	AttachmentClass=Class'WTFEquipFireAxeAttachment'
	ItemName="FIRE Axe"
	LightType=LT_None
	LightSaturation=0
	LightBrightness=100.000000
	bDynamicLight=True
	Skins(0)=Texture'WTF_A.Fireaxe.Fireaxe'
	SkinRefs(0)="WTF_A.Fireaxe.Fireaxe"
	AmbientGlow=10
}
