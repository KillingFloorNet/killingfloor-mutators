...
defaultproperties
{
     FireModeClass(0)=Class'WTFEquipWeldaFire'
     FireModeClass(1)=Class'WTFEquipWeldaFireB'
     AmmoClass(0)=Class'WTFEquipWeldaAmmo'
     Description="A deadly weapon"
     PickupClass=Class'WTFEquipWeldaPickup'
     AttachmentClass=Class'WTFEquipWeldaAttachment'
     ItemName="Welda profession"
     Skins(0)=Texture'WTF_A.Welda.Welda'
}
