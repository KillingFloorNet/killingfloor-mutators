...
class WTFZombiesBroodmother extends ZombieCrawler_Standard;
...
function SpawnBroodlings()
{
	...
	for (i=0; i < NUM_BROODLINGS; i++)
	{
		...
		{
			MyBroodling[i] = Spawn(Class'WTFZombiesBroodling',Owner,,loc,Rotation);
			Loc.X += 20;
			Loc.Y += 20;
		}
	}
...
defaultproperties
{
	...
	ControllerClass=Class'WTFZombiesBroodmotherController'
	Skins(0)=Texture'WTF_A.WTFZombies.Broodmother'
}
