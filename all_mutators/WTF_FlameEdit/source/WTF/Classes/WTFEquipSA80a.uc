...
simulated event RenderOverlays(Canvas Canvas)
{
	...
	else
	{
		...
		Canvas.SetPos(0, 0);
		Canvas.DrawTile(Texture'WTF_A.SA80.sa80cross', (Canvas.SizeX - Canvas.SizeY) / 2, Canvas.SizeY, 0.0, 0.0, 8, 8);
...
defaultproperties
{
     ZoomMat=Texture'WTF_A.SA80.sa80cross'
     MagCapacity=5
     ReloadRate=2.556667
     ReloadAnim="Reload"
     ...
     FireModeClass(0)=Class'WTFEquipSA80Fire'
     FireModeClass(1)=Class'WTFEquipSA80Zoom'
     PutDownAnim="PutDown"
