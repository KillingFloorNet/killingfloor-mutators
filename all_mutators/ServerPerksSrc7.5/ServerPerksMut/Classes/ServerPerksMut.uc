...
defaultproperties
{
	...
	SmileyTags(0)=(IconTag=">:(",IconTexture="ServerPerks.I_Mad")
	SmileyTags(1)=(IconTag=":(",IconTexture="ServerPerks.I_Frown")
	SmileyTags(2)=(IconTag=":)",IconTexture="ServerPerks.I_GreenLickB")
	SmileyTags(3)=(IconTag=":P",IconTexture="ServerPerks.I_Tongue",bCaseInsensitive=true)
	SmileyTags(4)=(IconTag=":d",IconTexture="ServerPerks.I_GreenLick")
	SmileyTags(5)=(IconTag=":D",IconTexture="ServerPerks.I_BigGrin")
	SmileyTags(6)=(IconTag=":|",IconTexture="ServerPerks.I_Indiffe")
	SmileyTags(7)=(IconTag=":/",IconTexture="ServerPerks.I_Ohwell")
	SmileyTags(8)=(IconTag=":*",IconTexture="ServerPerks.I_RedFace")
	SmileyTags(9)=(IconTag=":-*",IconTexture="ServerPerks.I_RedFace")
	SmileyTags(10)=(IconTag="Ban?",IconTexture="ServerPerks.I_Ban",bCaseInsensitive=true)
	SmileyTags(11)=(IconTag="B)",IconTexture="ServerPerks.I_Cool")
	SmileyTags(12)=(IconTag="Hmm",IconTexture="ServerPerks.I_Hmm")
	SmileyTags(13)=(IconTag="XD",IconTexture="ServerPerks.I_Scream")
	SmileyTags(14)=(IconTag="SPAM",IconTexture="ServerPerks.I_Spam")
}