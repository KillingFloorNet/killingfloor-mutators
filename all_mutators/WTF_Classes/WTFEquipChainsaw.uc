...
defaultproperties
{
     ...
     FireModeClass(0)=Class'WTF.WTFEquipChainsawFire'
     FireModeClass(1)=Class'WTF.WTFEquipChainsawAltFire'
     Description="A deadly weapon"
     PickupClass=Class'WTF.WTFEquipChainsawPickup'
     AttachmentClass=Class'WTF.WTFEquipChainsawAttachment'
