class WTFEquipFTProj extends FlameTendril;

var() WTFEquipFTFuelFlame FF;
var() bool bHasLanded;
...
simulated function Explode(vector HitLocation,vector HitNormal)
{
	...
	if ( KFHumanPawn(Instigator) != none )
	{
		...
		{
			Spawn(class'WTF.WTFEquipFTFuelFlame',self,,Location);
		}
	}
...
simulated function Landed( vector HitNormal )
{
	...
	if ( KFHumanPawn(Instigator) != none )
	{
		if ( EffectIsRelevant(Location,false) )
		{
			FF = Spawn(class'WTF.WTFEquipFTFuelFlame',self);
