...
{
     Weight=8.000000
     FireModeClass(0)=Class'WTF.WTFEquipFTFire'
     FireModeClass(1)=Class'WTF.WTFEquipFTFireSpray'
     AmmoClass(0)=Class'WTF.WTFEquipFTAmmo'
     Description="A deadly weapon"
     PickupClass=Class'WTF.WTFEquipFTPickup'
