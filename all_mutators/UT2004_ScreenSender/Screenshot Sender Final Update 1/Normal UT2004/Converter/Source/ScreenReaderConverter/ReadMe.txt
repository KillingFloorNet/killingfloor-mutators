================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: ScreenReaderConverter-Projektübersicht
===============================================================================

Der Anwendungs-Assistent hat diese ScreenReaderConverter-Anwendung für Sie 
...
finden, aus denen Ihre ScreenReaderConverter–Anwendung besteht.

ScreenReaderConverter.vcproj
...
ScreenReaderConverter.h
    ...
    die CScreenReaderConverterApp-Anwendungsklasse.

ScreenReaderConverter.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CScreenReaderConverterApp-
    Anwendungsklasse enthält.

ScreenReaderConverter.rc
...
res\ScreenReaderConverter.ico
    Dies ist eine Symboldatei, die als Symbol der Anwendung verwendet wird. 
    Dieses Symbol ist in der Hauptressourcendatei "ScreenReaderConverter.rc" 
    enthalten.

res\ScreenReaderConverter.rc2
...
ScreenReaderConverterDlg.h, ScreenReaderConverterDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CScreenReaderConverterDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "ScreenReaderConverter.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "ScreenReaderConverter.pch.pch2 und eine 
...
ScreenReaderConverter.manifest
