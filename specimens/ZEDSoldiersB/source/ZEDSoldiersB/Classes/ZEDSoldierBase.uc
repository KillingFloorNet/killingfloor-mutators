Class ZEDSoldierBase extends KFMonster Abstract;

//#exec obj load file="ZEDFX.uax" Package="ZEDSoldiers"
//#exec obj load file="ZEDSoldiers_S.uax"
...
defaultproperties
{
	...
	AmmoPerClip=20
	WeaponHitDamage(0)=1 //3
	WeaponHitDamage(1)=2 //4
	...
	MoanVoice=SoundGroup'ZEDSoldiers_S.Talk.ZEDTalk'
	KFHitFront="HitF"
	KFHitBack="HitB"
	KFHitLeft="HitL"
	KFHitRight="HitR"
	...
	NeckBone="Bip01 Neck"
	HitSound(0)=SoundGroup'ZEDSoldiers_S.Misc.ZEDPain'
	DeathSound(0)=SoundGroup'ZEDSoldiers_S.Misc.ZEDDie'
	...
	OriginalGroundSpeed=130.000000 //500.000000
	GroundSpeed=130.000000 //200.000000
	HealthMax=250.000000
	Health=250
	HeadHealth=200.000000
	MenuName="Civil Soldier"
	//ControllerClass=Class'ZEDSoldiersB.ZEDSoldierController'
	ControllerClass=Class'ZEDSoldierController'
