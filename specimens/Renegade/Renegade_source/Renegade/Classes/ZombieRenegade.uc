...
class ZombieRenegade extends ZombieRenegadeBase;

#exec OBJ LOAD FILE=KF_BaseClot.uax
#exec OBJ LOAD FILE=Renegade_A.ukx
#exec OBJ LOAD FILE=Renegade_T.utx
...
defaultproperties
{
     EventClasses(0)="Renegade.ZombieRenegade"
     EventClasses(1)="Renegade.ZombieRenegade"
     DetachedArmClass=Class'Renegade.SeveredArmRenegade'
     DetachedLegClass=Class'Renegade.SeveredLegRenegade'
     DetachedHeadClass=Class'Renegade.SeveredHeadRenegade'
}
