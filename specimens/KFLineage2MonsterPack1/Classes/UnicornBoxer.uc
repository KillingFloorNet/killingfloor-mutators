class UnicornBoxer extends Lineage2Monster;
...
defaultproperties
{
     ...
     IdleCrouchAnim="Run"
     IdleRestAnim="Run"
     Mesh=SkeletalMesh'Lineage2MonstersPack1v1.UnicornBoxer'
     DrawScale=2.000000
     Skins(0)=Texture'Lineage2MonstersPack1v1.Textures.unicorn_boxer_t00'
     SoundVolume=200
