...
final function Class<KFMonster> GetReplaceClass( Class<KFMonster> MC )
{
	...
	case Class'ZombieFleshPound':
		return Class'KFFirePounds.ZombieFirePound';
	default:
		return MC;
	}
}
...
defaultproperties
{
     ...
     FriendlyName="Fire and Flesh"
     Description="Turns FleshPounds into the ultimate killing machine."
}
