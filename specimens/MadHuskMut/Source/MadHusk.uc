...
//=============================================================================
class MadHusk extends ZombieHuskBase;
...
function SpawnTwoShots()
{
	...
	if ( !SavedFireProperties.bInitialized )
	{
		...
		SavedFireProperties.ProjectileClass = Class'CoolRocket';
    ...
    Spawn(Class'CoolRocket',,,FireStart,FireRotation);
...
function TakeDamage( int Damage, Pawn InstigatedBy, Vector Hitlocation, Vector Momentum, class<DamageType> damageType, optional int HitIndex)
{
	...
	if (DamageType == class 'DamTypeVomit' || DamageType == class 'DamTypeRocketImpact' || DamageType == class 'DamTypeFrag' || DamageType == class 'DamTypeM79Grenade' || DamageType == class 'DamTypeM32Grenade' || DamageType == class 'DamTypeLaw')
	{
...
{
     MeleeDamage=50
     DetachedArmClass=Class'MadHusk.SeveredArmMHusk'
     DetachedLegClass=Class'MadHusk.SeveredLegMHusk'
     DetachedHeadClass=Class'MadHusk.SeveredHeadMHusk'
     DetachedSpecialArmClass=Class'MadHusk.SeveredArmMHuskGun'
     HeadHealth=300.000000
     GroundSpeed=90.000000
     HealthMax=1000.000000
     Health=1000
     MenuName="Mad Husk"
     ControllerClass=Class'MadHusk.MadHuskController'
     Skins(0)=Texture'MD.burns.burns_tatters'
     Skins(1)=Shader'MD.burns.Mburns_shdr'
}
