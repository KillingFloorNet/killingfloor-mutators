...
#exec load obj file=FemaleFP_T.utx
#exec load obj file=FemaleFP_A.ukx
#exec load obj file=FemaleFP_Snd.uax
...
{
    Skins[3]=Shader'FemaleFP_T.FFPLights_Red_shader';
	Skins[1]=Combiner'FemaleFP_T.FFP_Metal_R_cmb';
}

simulated function DeviceGoNormal()
{
    Skins[3]=Shader'FemaleFP_T.FFPLights_Yellow_shader';
	Skins[1]=Combiner'FemaleFP_T.FFP_Metal_cmb';
}
...
{
	myLevel.AddPrecacheMaterial(Texture'FemaleFP_T.BraTexture');
	myLevel.AddPrecacheMaterial(Combiner'FemaleFP_T.FFP_Metal_cmb');
	myLevel.AddPrecacheMaterial(Combiner'FemaleFP_T.FFP_Metal_R_cmb');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFPLights_Yellow_shader');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFPLights_Red_shader');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFP_Skin1_Sdr');
}

defaultproperties
{
     ChargingAnim="Rage_Run"
     VentEffectClass=Class'FemaleFPZED_v095.FFPVentEmitter'
     ...
     HitAnims(1)="Hit"
     HitAnims(2)="Hit"
     MoanVoice=SoundGroup'FemaleFP_Snd.Voice.G_Talk'
     KFHitFront="Hit"
     KFHitBack="Hit"
     KFHitLeft="Hit"
     KFHitRight="Hit"
     ...
     JumpSound=SoundGroup'FemaleFP_Snd.Voice.G_Jump'
     ...
     DetachedArmClass=Class'FemaleFPZED_v095.SeveredArmFFP'
     DetachedLegClass=Class'FemaleFPZED_v095.SeveredLegFFP'
     ...
     HitSound(0)=SoundGroup'FemaleFP_Snd.Voice.G_Pain'
     DeathSound(0)=SoundGroup'FemaleFP_Snd.Voice.G_Death'
     ChallengeSound(0)=SoundGroup'FemaleFP_Snd.Voice.G_Challenge'
     ChallengeSound(1)=SoundGroup'FemaleFP_Snd.Voice.G_Challenge'
     ChallengeSound(2)=SoundGroup'FemaleFP_Snd.Voice.G_Challenge'
     ChallengeSound(3)=SoundGroup'FemaleFP_Snd.Voice.G_Challenge'
     ScoringValue=200
     IdleHeavyAnim="Idle"
     IdleRifleAnim="Idle"
     ...
     ControllerClass=Class'FemaleFPZED_v095.FFPController'
     ...
     AmbientSound=SoundGroup'FemaleFP_Snd.Voice.G_Idle'
     Mesh=SkeletalMesh'FemaleFP_A.FFP_PG13_mesh'
     Skins(0)=Texture'FemaleFP_T.BraTexture'
     Skins(1)=Combiner'FemaleFP_T.FFP_Metal_cmb'
     Skins(2)=Combiner'FemaleFP_T.FFP_Metal_cmb'
     Skins(3)=Shader'FemaleFP_T.FFPLights_Yellow_shader'
     Skins(4)=Shader'FemaleFP_T.FFP_Skin1_Sdr'
     CollisionRadius=26
     Mass=500.000000
