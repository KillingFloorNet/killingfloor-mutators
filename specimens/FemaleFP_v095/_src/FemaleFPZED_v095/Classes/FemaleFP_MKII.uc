...
{
    Skins[3]=Shader'FemaleFP_T.FFPLights_Blue_shader';
	Skins[1]=Combiner'FemaleFP_T.FFP_Metal_B_cmb';
    Skins[4]=Shader'FemaleFP_T.FFP_Skin1_B_Sdr';
}

simulated function DeviceGoNormal()
{
    Skins[3]=Shader'FemaleFP_T.FFPLights_Green_shader';
	Skins[1]=Combiner'FemaleFP_T.FFP_Metal_G_cmb';
...
static simulated function PreCacheMaterials(LevelInfo myLevel)
{
	...
	myLevel.AddPrecacheMaterial(Combiner'FemaleFP_T.FFP_Metal_G_cmb');
	myLevel.AddPrecacheMaterial(Combiner'FemaleFP_T.FFP_Metal_B_cmb');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFPLights_Green_shader');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFPLights_Blue_shader');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFP_Skin1_Sdr');
	myLevel.AddPrecacheMaterial(Shader'FemaleFP_T.FFP_Skin1_B_Sdr');
}
...
defaultproperties
{
    ...
    Skins(1)=Combiner'FemaleFP_T.FFP_Metal_G_cmb'
    Skins(2)=Combiner'FemaleFP_T.FFP_Metal_G_cmb'
    Skins(3)=Shader'FemaleFP_T.FFPLights_Green_shader'
    Skins(4)=Shader'FemaleFP_T.FFP_Skin1_Sdr'
