...
//
//-----------------------------------------------------------
class Kf2BossZombieController extends KFMonsterController;
...
function FightEnemy(bool bCanCharge)
{
	...
	if ( !EnemyVisible() )
	{
        ...
        if( bAlreadyFoundEnemy || ZombieKf2Boss(Pawn).SneakCount > 2 )
        {
...
Begin:
	...
	if( HidingSpots==None )
		ZombieKf2Boss(Pawn).BeginHealing();
