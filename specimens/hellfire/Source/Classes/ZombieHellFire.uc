...
//=============================================================================
class ZombieHellFire extends ZombieHellFireBase;
...
function SpawnTwoShots()
{
	...
	if ( !SavedFireProperties.bInitialized )
	{
		...
		SavedFireProperties.ProjectileClass = Class'HellFireFireProjectile';
    ...
    Spawn(Class'HellFireFireProjectile',,,FireStart,FireRotation);
...
defaultproperties
{
     ...
     ControllerClass=Class'HellFire.HellFireZombieController'
}
