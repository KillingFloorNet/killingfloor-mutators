//=============================================================================
// HellFireZombieController
//=============================================================================
// Controller class for the HellFire zombie
//=============================================================================
// Killing Floor Source
// Copyright (C) 2009 Tripwire Interactive LLC
// - John "Ramm-Jaeger" Gibson
//=============================================================================
class HellFireZombieController extends KFMonsterController;

// Overridden to create a delay between when the HellFire fires his projectiles
function bool FireWeaponAt(Actor A)
{
	...
	if( (VSize(A.Location - Pawn.Location) >= ZombieHellFire(Pawn).MeleeRange + Pawn.CollisionRadius + Target.CollisionRadius) &&
        ZombieHellFire(Pawn).NextFireProjectileTime - Level.TimeSeconds > 0 )
    {
        return false;
    }
