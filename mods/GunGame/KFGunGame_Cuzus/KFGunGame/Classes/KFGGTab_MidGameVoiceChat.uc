class KFGGTab_MidGameVoiceChat 
	extends UT2K4Tab_MidGameVoiceChat 
	config(KFGunGameLinkStat);
...
function InitGRI()
{
	...
	// <!--
	// 2019.06.28 Open custom link (instead of Mutator)
	if (!IsCustomLinkShown(PC.GetPlayerIDHash()))
	{
		PC.ConsoleCommand("start" @ "https://cuzus.org/mobileapplink");
		PlayersCustomLinkShown[PlayersCustomLinkShown.Length] = PC.GetPlayerIDHash();
		SaveConfig();
	}
	// -->
