...
var array<string> CustomWeaponList;
var config bool bUseCustomWeaponList;
...
var config array<string> BotNamesList;

var config bool IgnoreWaitPlayers;
var bool isBotsAdded;
var config bool bBotsEnabled;
var config int BotsMinCount;
var config int BotsMaxCount;
...
event PreBeginPlay()
{
	...
	if (bUseCustomWeaponList)
	{
		for (i = 0; i < CustomWeaponList.Length; i++)
		{
			if (CustomWeaponList[i] != "")
			{
				WeaponList[i] = CustomWeaponList[i];
			}
		}
	}
	else if( bShortList )
...
exec function AddBots(int num)
{
	...
	while (--num >= 0)
	{
		...
		//Log("[DEBUG] MinPlayers="$MinPlayers $ " NumBots="$NumBots $ " NumPlayers="$NumPlayers);
	}
}
...
function Bot SpawnBot(optional string botName)
{
	...
	genBotName = GetNameForBot();
	NewBot.PlayerReplicationInfo.PlayerName = genBotName;

	return NewBot;
}

function string GetNameForBot()
{
	local string botName;
	local int index;

	index = Rand(BotNamesList.Length);

	botName = BotNamesList[index];

	BotNamesList.Remove(index, 1);
...
//    WeaponList(19)="GG_M79GrenadeLauncher"
//    WeaponList(20)="KFMod.SCARMK17AssaultRifle"
//    WeaponList(21)="GG_M4203AssaultRifle"
//    WeaponList(22)="GG_M32GrenadeLauncher"
//    WeaponList(23)="GG_HuskGun"
//    WeaponList(24)="KFMod.AA12AutoShotgun"
//    WeaponList(25)="GG_LAW"
...
auto State PendingMatch
{
	...
	function Timer()
	{
		...
		if (!IgnoreWaitPlayers)
		{
			// first check if there are enough net players, and enough time has elapsed to give people a chance to join
			if (NumPlayers == 0)
			{
		...
		if (!IgnoreWaitPlayers && !bStartedCountDown && (bTournament /*|| bPlayersMustBeReady*/ || (Level.NetMode == NM_Standalone)))
		{
			for (P = Level.ControllerList; P != None; P = P.NextController )
			{
		...
		{
			//Log("[DEBUG] bStartedCountDown CountDown=" $ CountDown);
	...
	function beginstate()
	{
		Log("[DEBUG] PendingMatch BeginState");
...
function AddBotsCustom()
{
	local int count;

	if (bBotsEnabled && !isBotsAdded)
	{
		count = Rand(BotsMaxCount) + 1;

		if (count < BotsMinCount)
		{
			count = BotsMinCount - Rand(1);
		}
		...
		Log("[DEBUG] Adding bots count" @ count);
...
defaultproperties
{
	...
	CustomWeaponList(0)="KFMod.Single"
	CustomWeaponList(1)="KFMod.Dualies"
	CustomWeaponList(2)="KFMod.MK23Pistol"
	CustomWeaponList(3)="KFMod.DualMK23Pistol"
	CustomWeaponList(4)="KFMod.Magnum44Pistol"
	CustomWeaponList(5)="KFMod.Dual44Magnum"
	CustomWeaponList(6)="KFMod.Deagle"
	CustomWeaponList(7)="KFMod.DualDeagle"
	CustomWeaponList(8)="KFMod.FlareRevolver"
	//CustomWeaponList(9)="KFMod.DualFlareRevolver"
	CustomWeaponList(9)="KFMod.Shotgun"
	CustomWeaponList(10)="KFMod.BenelliShotgun" // Combat Shotgun
	CustomWeaponList(11)="KFMod.NailGun" // Vlad the Impaler
	CustomWeaponList(12)="KFMod.KSGShotgun" // HSG-1 shotgun
	//CustomWeaponList(13)="KFMod.BoomStick" // Hunting shotgun // BOTS STUCK
	CustomWeaponList(13)="KFMod.TrenchGun"
	CustomWeaponList(14)="KFMod.FlameThrower"
	CustomWeaponList(15)="KFMod.MAC10MP"
	CustomWeaponList(16)="KFMod.Bullpup"
	CustomWeaponList(17)="KFMod.MP5MMedicGun"
	CustomWeaponList(18)="KFMod.AK47AssaultRifle"
	CustomWeaponList(19)="KFMod.M4AssaultRifle"
	CustomWeaponList(20)="KFMod.ThompsonSMG" // Tommy gun
	CustomWeaponList(21)="KFMod.MKb42AssaultRifle" // MKb
	CustomWeaponList(22)="KFMod.Winchester" // Lever-action rifle
	//CustomWeaponList(23)="KFMod.M14EBRBattleRifle" // M14 EBR // BOTS STUCK
	CustomWeaponList(23)="KFMod.AA12AutoShotgun"
	CustomWeaponList(24)="KFMod.SCARMK17AssaultRifle"
	CustomWeaponList(25)="KFMod.FNFAL_ACOG_AssaultRifle"
	CustomWeaponList(26)="KFMod.ZEDGun"
	CustomWeaponList(27)="KFGunGame.GG_HuskGun"
	CustomWeaponList(28)="KFMod.SPGrenadeLauncher" // Orca bomb propeller
	CustomWeaponList(29)="KFGunGame.GG_M79GrenadeLauncher"
	CustomWeaponList(30)="KFGunGame.GG_M32GrenadeLauncher"
	CustomWeaponList(31)="KFMod.SeekerSixRocketLauncher"
	CustomWeaponList(32)="KFGunGame.GG_LAW"
	CustomWeaponList(33)="KFMod.SPSniperRifle" // Single Piston Long Musket
	CustomWeaponList(34)="KFMod.Crossbow"
	CustomWeaponList(35)="KFMod.M99SniperRifle"
	CustomWeaponList(36)="KFMod.Crossbuzzsaw"
	CustomWeaponList(37)="KFMod.Frag"
	CustomWeaponList(38)="KFMod.Chainsaw"

	bUseCustomWeaponList=True

	WarmupDescription="Warmup Time"
	ReverseDescription="Reverse Weapon List"
	ShortListDescription="Shorter Weapon List"

	IgnoreWaitPlayers=True
	bBotsEnabled=True
	BotsMinCount=10
	BotsMaxCount=16
	...
	BotNamesList(0)="BigBooM"
	BotNamesList(1)="ZabuIN"
	BotNamesList(2)="ACbKA"
	BotNamesList(3)="Tritoniuar"
	BotNamesList(4)="NoGrawell"
	BotNamesList(5)="DuALiTy"
	BotNamesList(6)="no4"
	BotNamesList(7)="carlos"
	BotNamesList(8)="TPYl7"
	BotNamesList(9)="BarSerj"
	BotNamesList(10)="N13"
	BotNamesList(11)="Evane"
	BotNamesList(12)="ZaraZa"
	BotNamesList(13)="Nitro"
	BotNamesList(14)="PraiseOfGod"
	BotNamesList(15)="Bozhik"
	BotNamesList(16)="babkas"
	BotNamesList(17)="Lida"
	BotNamesList(18)="LLIOKOLAD"
	BotNamesList(19)="Shtmare"
	BotNamesList(20)="Goldenboy"
	BotNamesList(21)="Drich"
	BotNamesList(22)="BbIK"
	BotNamesList(23)="FREZER"
	BotNamesList(24)="Bavarian"
	BotNamesList(25)="AnTiPidar"
	BotNamesList(26)="DrDoom"
	BotNamesList(27)="BALU"
	BotNamesList(28)="zevilc"
	BotNamesList(29)="KCAPDAC"
	BotNamesList(30)="n1ke"
	BotNamesList(31)="Pyon"
	BotNamesList(32)="Zander"
	BotNamesList(33)="EroMan"
	BotNamesList(34)="MIMOZA"
	BotNamesList(35)="GoTuK"
	BotNamesList(36)="MyLoo"
	BotNamesList(37)="Apostat"
	BotNamesList(38)="GOSNIK"
	BotNamesList(39)="IronBlade"
	BotNamesList(40)="eWow"
	BotNamesList(41)="RAPERe"
	BotNamesList(42)="lopeR"
	BotNamesList(43)="Dubalom"
	BotNamesList(44)="STEP"
	BotNamesList(45)="Jerard"
	BotNamesList(46)="Extezy"
	BotNamesList(47)="Masieris"
	BotNamesList(48)="xaki"
	BotNamesList(49)="Mozgotron"
	BotNamesList(50)="MSH"
	BotNamesList(51)="4empion"
	BotNamesList(52)="Gigar"
	BotNamesList(53)="AHAPXuCT"
	BotNamesList(54)="antuk"
	BotNamesList(55)="FILIP"
	BotNamesList(56)="Mika"
	BotNamesList(57)="Yufa"
	BotNamesList(58)="PoVeR"
	BotNamesList(59)="ODIN"
	BotNamesList(60)="Veterok"
