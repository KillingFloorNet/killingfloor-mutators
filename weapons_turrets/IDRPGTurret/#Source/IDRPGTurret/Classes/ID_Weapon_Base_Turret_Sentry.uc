// Written by Marco
class ID_Weapon_Base_Turret_Sentry extends SVehicle // Gay hack, but has to be done.
	Placeable
	Config(IDRPGTurret)
	CacheExempt;
    
#exec obj load file="IDRPGTurret_T.utx"
#exec obj load file="IDRPGTurret_S.uax"
...
simulated function PlayTurretDied()
{
	...
	Skins[0] = Texture'IDRPGTurret_T.sentrygun';
	SetTimer(0,false);
}
...
defaultproperties
{
    ...
    TurretHealth=600
    EffectiveRange=5000
    HitDgeType=Class'IDRPGTurret.ID_Weapon_Base_Turret_DamageType'
    FireRateTime=0.50000
    //Health=600
    ...
    BarrelBones(2)="tip"
    BarrelBones(3)="tip"
    LaserOffset=(X=12,Z=11.800000)
    VehicleMass=1
    Team=250
    VehicleNameString="USCM Sentry Gun"
    bCanBeBaseForPawns=False
    PeripheralVision=0.700000
    MenuName="Turret"
    ControllerClass=Class'IDRPGTurret.ID_Weapon_Base_Turret_Sentry_AI'
    bStasis=False
    Mesh=SkeletalMesh'IDRPGTurret_A.USCMSentryGun'
    Skins(0)=Texture'IDRPGTurret_T.Weapons.sentrygun'
    SoundRadius=140
    ...
    CollisionHeight=10.000000
     ...
     End Object
    KParams=KarmaParamsRBFull'IDRPGTurret.ID_Weapon_Base_Turret_Sentry.KarmaParamsRBFull0'
