class Rocket_Weapon_Base_Turret_Attachment extends KFWeaponAttachment;

defaultproperties
{
     mMuzFlashClass=Class'ZEDMKIIMuzzleFlash3P'
     ...
     StaticMesh=StaticMesh'RocketRPGTurret.Laptop'
}
