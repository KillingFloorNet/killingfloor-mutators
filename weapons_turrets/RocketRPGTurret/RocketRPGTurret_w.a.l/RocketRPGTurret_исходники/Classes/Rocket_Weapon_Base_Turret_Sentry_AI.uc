// A very simple AI!
Class Rocket_Weapon_Base_Turret_Sentry_AI extends AIController;

var Rocket_Weapon_Base_Turret_Sentry Turret;
var transient float NextShotTime;

function Restart()
{
	Super.Restart();
	Turret = Rocket_Weapon_Base_Turret_Sentry(Pawn);
	GoToState('IDle');
}
