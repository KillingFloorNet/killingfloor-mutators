class SentryBotGun extends KFWeapon;

var SentryBotTurret CurrentSentry;
...
{
	MagCapacity=1
	HudImage=Texture'SentryBot_A.Sentry.I_Sentry'
	SelectedHudImage=Texture'SentryBot_A.Sentry.I_Sentry'
	Weight=1.000000
	bModeZeroCanDryFire=True
	TraderInfoTexture=Texture'SentryBot_A.Sentry.I_Sentry'
	...
	InventoryGroup=5
	GroupOffset=6
	PickupClass=Class'SentryBotGunPickup'
	PlayerViewOffset=(X=25.000000,Z=-25.000000)
	BobDamping=6.000000
	AttachmentClass=Class'SentryBotGunAttachment'
