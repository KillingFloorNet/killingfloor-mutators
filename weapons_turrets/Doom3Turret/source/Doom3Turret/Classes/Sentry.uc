...
var Emitter mTracer;
var SentryWeaponFlash WeaponFlash;
var transient float NextVoiceTimer;
var SentryGun WeaponOwner;
...
simulated function SetAnimationNum( byte Num )
{
	...
	case 2:
		...
		{
			WeaponFlash = Spawn(Class'SentryWeaponFlash',Self);
...
function Died(Controller Killer, class<DamageType> damageType, vector HitLocation)
{
	...
	if( WeaponOwner!=None )
	{
		if( OwnerPawn!=None && PlayerController(OwnerPawn.Controller)!=None )
			PlayerController(OwnerPawn.Controller).ReceiveLocalizedMessage(Class'SentryMessage',2);
...
ignores Trigger, Bump, HitWall, HeadVolumeChange, PhysicsVolumeChange, Falling, BreathTimer, TakeDamage, Landed, SetAnimationNum, Timer;
	...
	simulated function EndState()
	{
		...
		if( Level.NetMode!=NM_DedicatedServer )
		{
			...
			PlaySound(Sound'KF_GrenadeSnd.Nade_Explode_1',SLOT_Pain,2.5f,,800.f);
		}
...
defaultproperties
{
     hitdamage=7
     SentryHealth=250
     FootStep(0)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sstep_01'
     FootStep(1)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sstep_02'
     FootStep(2)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sstep_03'
     FootStep(3)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sstep_04'
     VoicesList(0)=Sound'2009DoomMonstersSounds.Sentry.Sentry_activate_01'
     VoicesList(1)=Sound'2009DoomMonstersSounds.Sentry.Sentry_cant_reach_player_01'
     VoicesList(2)=Sound'2009DoomMonstersSounds.Sentry.Sentry_cant_reach_player_02'
     VoicesList(3)=Sound'2009DoomMonstersSounds.Sentry.Sentry_destroyed_01'
     VoicesList(4)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fight_enemy_02'
     VoicesList(5)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sight_enemy_01'
     VoicesList(6)=Sound'2009DoomMonstersSounds.Sentry.Sentry_lost_target_01'
     VoicesList(7)=Sound'2009DoomMonstersSounds.Sentry.Sentry_pain_01'
     VoicesList(8)=Sound'2009DoomMonstersSounds.Sentry.Sentry_pain_02'
     VoicesList(9)=Sound'2009DoomMonstersSounds.Sentry.Sentry_pain_03'
     VoicesList(10)=Sound'2009DoomMonstersSounds.Sentry.Sentry_pain_04'
     VoicesList(11)=Sound'2009DoomMonstersSounds.Sentry.Sentry_shutdown_01'
     VoicesList(12)=Sound'2009DoomMonstersSounds.Sentry.Sentry_sight_friendly_01'
     VoicesList(13)=Sound'2009DoomMonstersSounds.Sentry.Sentry_wait_for_player_01'
     VoicesList(14)=Sound'2009DoomMonstersSounds.Sentry.Sentry_wait_for_player_02'
     VoicesList(15)=Sound'2009DoomMonstersSounds.Sentry.Sentry_wait_for_player_03'
     FiringSounds(0)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fire_01'
     FiringSounds(1)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fire_02'
     FiringSounds(2)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fire_03'
     FiringSounds(3)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fire_04'
     FiringSounds(4)=Sound'2009DoomMonstersSounds.Sentry.Sentry_fire_05'
     ...
     EyeHeight=0.000000
     Health=250
     ControllerClass=Class'Doom3KFBeta4.SentryController'
     bPhysicsAnimUpdate=True
     ...
     PrePivot=(Z=-5.000000)
     Skins(0)=Texture'2009DoomMonstersTex.Sentry.SentrySpistonDiffuse'
     Skins(1)=Texture'2009DoomMonstersTex.Sentry.SentryFlapDiffuse'
     Skins(2)=Texture'2009DoomMonstersTex.Sentry.SentrySkin2'
     Skins(3)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
     Skins(4)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
     Skins(5)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
     Skins(6)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
     Skins(7)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
     Skins(8)=Shader'2009DoomMonstersTex.Sentry.InvisibleWeaponsFlash'
