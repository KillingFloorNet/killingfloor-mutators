// A very simple AI!
Class Burn_Weapon_Base_Turret_Sentry_AI extends AIController;

var Burn_Weapon_Base_Turret_Sentry Turret;
var transient float NextShotTime;

function Restart()
{
	Super.Restart();
	Turret = Burn_Weapon_Base_Turret_Sentry(Pawn);
	GoToState('IDle');
}
