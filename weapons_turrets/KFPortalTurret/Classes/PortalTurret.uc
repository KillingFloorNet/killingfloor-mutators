...
defaultproperties
{
     ...
     AlarmNoiseSnd=Sound'KFPortalTurret.Base.Talert'
     DiedSnd=Sound'KFPortalTurret.Base.Tdie'
     LockedOnSnd=Sound'KFPortalTurret.Base.Tactive'
     Voices(0)=SoundGroup'KFPortalTurret.Speech.GTurretActivate'
     Voices(1)=SoundGroup'KFPortalTurret.Speech.GTurretCollide'
     Voices(2)=SoundGroup'KFPortalTurret.Speech.GTurretDisabled'
     Voices(3)=SoundGroup'KFPortalTurret.Speech.GTurretFF'
     Voices(4)=SoundGroup'KFPortalTurret.Speech.GTurretPickup'
     Voices(5)=SoundGroup'KFPortalTurret.Speech.GTurretSearching'
     Voices(6)=SoundGroup'KFPortalTurret.Speech.GTurretSleep'
     Voices(7)=SoundGroup'KFPortalTurret.Speech.GTurretTipped'
     HitDamages=5
     TurretHealth=400
     HitDgeType=Class'KFPortalTurret.DamTypeTurret'
     ...
     Health=400
     MenuName="Turret"
     ControllerClass=Class'KFPortalTurret.TurretAI'
     bStasis=False
     Mesh=SkeletalMesh'KFPortalTurret.TurretMesh'
     Skins(0)=Combiner'KFPortalTurret.Skins.JTurretA'
     ...
     End Object
     KParams=KarmaParamsRBFull'KFPortalTurret.PortalTurret.KarmaParamsRBFull0'
