...
defaultproperties
{
     ...
     TraderInfoTexture=Texture'KFPortalTurret.Icons.I_Turret'
     ...
     InventoryGroup=5
     GroupOffset=6
     PickupClass=Class'KFPortalTurret.PTurretPickup'
     PlayerViewOffset=(X=25.000000,Z=-25.000000)
     BobDamping=6.000000
     AttachmentClass=Class'KFPortalTurret.PTurretAttachment'
     IconCoords=(X1=245,Y1=39,X2=329,Y2=79)
     ItemName="PortalTurret Turret"
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'KFPortalTurret.pickups.PTurretMesh'
     Skins(0)=Combiner'KFPortalTurret.Skins.JTurretB'
     AmbientGlow=35
}
