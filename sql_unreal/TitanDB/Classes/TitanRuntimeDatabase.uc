//============================================================
// TitanRuntimeDatabase.uc	- Database which only exists in memory
//============================================================
//	TitanDB
...
//============================================================
//
// Implements a database which only exists while the server
// is running; used during development, don't think it will
// have much other use though (perhaps as a local cache for
// the MySQL database? Though it would probably be more
// efficient to implement that seperately).
//
//============================================================
Class TitanRuntimeDatabase extends TitanDatabase;


struct PlayerDatabaseEntry
{
//	var PlayerController		PC;
	var string			Names;
	var string			GUID;
	var string			GamespyID;
	var string			IPs;
	var array<PlayerProperty>	ExtraData;
};

var array<PlayerDatabaseEntry>		LocalDatabase;
var bool				bDisableAutoSave; // Used for the INI database, but put here so I can just copy/paste

var deprecated bool bTestThisCode;
var deprecated bool bRuntimeDBRevision1;
